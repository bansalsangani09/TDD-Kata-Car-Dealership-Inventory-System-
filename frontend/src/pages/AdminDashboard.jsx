...
const AdminDashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Form Section */}
      {showForm && (
        <div className="mb-8 rounded-2xl bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <button
              onClick={cancelForm}
              className="p-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700/50 transition-all cursor-pointer"
            >
